...
public class SessionController {
    ...
    @ApiOperation(value = "세션 생성", notes = "code와 message 반환")
    @PostMapping()
    ...
    @ApiOperation(value = "세션 목록", notes = "스터디의 세션 목록을 반환")
    ...
    @ApiOperation(value = "세션 조회", notes = "세션의 정보를 반환")
    ...
    @ApiOperation(value = "세션 수정", notes = "code와 message 반환")
    @PutMapping()
    ...
    @ApiOperation(value = "세션 삭제", notes = "code와 message 반환")
