...
public enum Oauth {
    GOOGLE {
        ...
        public OauthToken getAccessToken(String code) {
            return Oauth.getTokenByPost(code, Information.google);
        }
    ...
    KAKAO {
        ...
        @Override
        public OauthToken getAccessToken(String code) {
            return Oauth.getTokenByGet(code, Information.kakao);
        }
    ...
    NAVER {
        ...
        @Override
        public OauthToken getAccessToken(String code) {
            return Oauth.getTokenByGet(code, Information.naver);
        }
    ...
    GITHUB {
        ...
        @Override
        public OauthToken getAccessToken(String code) {
            return Oauth.getTokenByPost(code, Information.github);
        }
